...
const { stdout, stderr } = new Deno.Command("wincompile.cmd", { args: [`--Icon=.\\Logo\\uniconvert.ico`, `--FileDescription=UniConvert`, `--FileVersion=2.6.0`, `--LegalCopyright=\xa9 OhHellNaw`, `--OriginalFilename=uniconvert.exe`, `--ProductName=UniConvert`, `--ProductVersion=2.6.0`, `--`, `-A`, `--unstable`, `main.ts`], stdout: "piped", stderr: "piped" }).outputSync();
